...
// Convenience readable store of zero remaining with count message, derived from config.
export const zeroRemainingWithCount = derived( config, $config => $config.zero_remaining_with_count );
